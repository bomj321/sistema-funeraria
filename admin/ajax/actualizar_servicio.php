...
if (isset($_GET['id_servicio_entregar']) AND isset($_GET['actualizar_servicio']))//codigo elimina un elemento del array
{
    ...
    $sql="UPDATE planes_has_services_delivered SET entregado ='1' WHERE id_servicios_delivered= ? ";
...
////////////////////ENTREGAR SERVICIO CIERRO
 ...
 <h4 style="text-align: center;">Servicios del Plan </h4>
              <?php
                    $sql_servicios = "SELECT * FROM Servicios INNER JOIN planes_has_services_delivered ON planes_has_services_delivered.servicio_id_servicios = Servicios.id_servicios && planes_has_services_delivered.idUser_services= $id_user_session  AND planes_has_services_delivered.planes_id_planes=$id_plan";
                    ...
                    <tbody>
                      ...
                      <tr>            
                        ...
                        <input type="hidden" value="<?php echo $id_plan?>" id="servicio_plan<?php echo $id_servicio;?>">
                      </tr>
                      <?php 
