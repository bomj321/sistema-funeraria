...
<table class="responsive-table">
            ...
            <tbody>          <?php 
              ...
              <tr>
                ...
                <td><div>
               <input disabled type="text" class="form-control sinborde text-left" id="nombre_servicio_contrato_editar<?php echo $id_servicio; ?>"  value="<?php echo $fila['descripcion_servicio'];?>">
                 </div></td>

                <td><div>
               <input  type="text" class="form-control sinborde text-left" id="cantidad_servicio_contrato_editar<?php echo $id_servicio; ?>"  value="1">
                 </div></td>

                 <td><div>
               <input disabled type="text" class="form-control sinborde text-left"  id="precio_servicio_venta_contrato_editar<?php echo $id_servicio; ?>" value="<?php echo $fila['costo'];?>">
                 </div></td>


                <td><a class='btn btn-info green' type="button" onclick="agregar_contrato_servicio_editar('<?php echo $id_servicio ?>')">
